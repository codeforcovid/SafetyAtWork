...
public class CubeModelDbFormat {
    ...
    public CubeModelDbFormat(int id, String tower_number, String floor_number, String odc_number, String row_number, String cube_id,
    ...
    public CubeModelDbFormat(String cube_id, String seat_code, int seat_status) {
        this.cube_id = cube_id;
        this.seat_code = seat_code;
        this.seat_status = seat_status;
    }

    public CubeModelDbFormat(String cube_id, String seat_code, int seat_status, EmployeeSeatModel defaultEmployeeSeatModel) {
        this.cube_id = cube_id;
        this.seat_code = seat_code;
        this.seat_status = seat_status;
        this.defaultEmployeeSeatModel = defaultEmployeeSeatModel;
    ...
    public CubeModelDbFormat(String cube_id, String seat_code, int seat_status, EmployeeSeatModel defaultEmployeeSeatModel, EmployeeSeatModel temporaryEmployeeSeatModel) {
        this.cube_id = cube_id;
        this.seat_code = seat_code;
        this.seat_status = seat_status;
        this.defaultEmployeeSeatModel = defaultEmployeeSeatModel;
    ...
    public CubeModelDbFormat(int id, String cube_id, String seat_code, int seat_status, EmployeeSeatModel defaultEmployeeSeatModel, EmployeeSeatModel temporaryEmployeeSeatModel) {
        this.id = id;
        this.cube_id = cube_id;
        this.seat_code = seat_code;
        this.seat_status = seat_status;
