...
public class CreateAlarmFragment extends Fragment {
    ...
    @BindView(R.id.fragment_createalarm_recurring_options_one) LinearLayout recurringOptionsOne;
    @BindView(R.id.fragment_createalarm_recurring_options_two) LinearLayout recurringOptionsTwo;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recurring.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    recurringOptionsOne.setVisibility(View.VISIBLE);
                    recurringOptionsTwo.setVisibility(View.VISIBLE);
                } else {
                    recurringOptionsOne.setVisibility(View.GONE);
                    recurringOptionsTwo.setVisibility(View.GONE);
                }
            }
        });
